...
async function prepareBuildRequestForPlatformAsync(builder) {
    ...
    const runtimeAndFingerprintMetadata = await computeAndMaybeUploadRuntimeAndFingerprintMetadataAsync(ctx);
    const metadata = await (0, metadata_1.collectMetadataAsync)(ctx, runtimeAndFingerprintMetadata);
...
async function computeAndMaybeUploadFingerprintFromExpoUpdatesAsync(ctx) {
